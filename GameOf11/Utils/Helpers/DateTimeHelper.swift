...
class DateTimeHelper {
    ...
    func getDate(format: String, dateString: String) -> Date {
    ...
    func getDateString(atFormat: String, fromFormat: String, dateString: String) -> String {
    ...
    func getDateString(atFormat: String, date: Date) -> String {
